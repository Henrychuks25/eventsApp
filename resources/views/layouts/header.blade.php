            ...
            <div class="lgx-container" >
                ...
                <nav class="navbar navbar-default lgx-navbar navbar-expand-lg">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        ...
                        <div class="lgx-nav-right navbar-right">
                            <div class="lgx-cart-area">
                                <a class="lgx-btn lgx-btn-red" href="{{ route('events_index') }}"><i class="fas fa-calendar-day"></i> @lang('eventmie::em.browse') @lang('eventmie::em.events')</a>
                            </div>
                        </div>
                        <ul class="nav navbar-nav lgx-nav navbar-right">
                            ...
                            @guest
                            <li>
                                <a class="lgx-scroll" href="{{ route('login') }}"><i class="fas fa-fingerprint"></i> @lang('em.login')</a>
                            </li>
                            @else
