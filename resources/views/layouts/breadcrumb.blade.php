...
<section>
    <div id="lgx-schedule" class="lgx-schedule lgx-schedule-dark">
        <div class="lgx-inner-breadcrumb" style="background-image: url({{ asset('/img/bg-pattern.png') }});">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="breadcrumb-area">
                            ...
                            <ol class="breadcrumb">
                                <li>
                                    ...
                                    <a href="{{route('welcome')}}">@lang('em.home')</a>
                                </li>

                                @php
                                    $i_count = 1;
                                    if(config('route.prefix'))
                                    {
                                        $i_count = 2;
                                        $prefix_count = count(explode('/', config('route.prefix')));
                                        if($prefix_count > 1)
